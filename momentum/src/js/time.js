export default class Time {
    ...
    switchBg(fromBtn) {
        if (fromBtn) {
            ...
            img.src = `/momentum/src/assets/images/${this.dayTime}/${this.bgMas[this.tempBg]}.jpg`;
            img.onload = () => {
        ...
        if (this.curentBg !== this.timeNumbers[0]) {
            ...
            this.checkTime();
            this.body.style.backgroundImage = `url('/momentum/src/assets/images/${this.dayTime}/${this.bgMas[this.curentBg]}.jpg')`;
